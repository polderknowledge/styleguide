...
For an example, try copying and pasting the code from the KB's CSS in HTML Email into the Polder Knowledge app. Toggle to code view, and note that only the code you copied is included.
