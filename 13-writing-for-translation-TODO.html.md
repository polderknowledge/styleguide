...
Polder Knowledge serves users in different countries and territories, not just the Netherlands. As our user base grows, it becomes more and more important that our content is accessible to people around the world.
...
Our Knowledge Base is available to all emproyees in English, with more languages in development. Sometimes other pieces of content will be translated as well.
...
Polder Knowledge’s voice conversational and informal. However, in some cultures, informal text may be considered offensive. Check with your translator to see if this is the case for the particular language you’re writing for.
...
When writing text that will be translated, be careful about making references to things of local or regional importance. These may not be recognizable to readers outside the Netherlands.
...
#### Repeat helping verbs belonging to multiple verbs
  ...
  - Yes: Polder Knowledge can send your campaign on the fly or can schedule your campaign to go out at a set time.
  - No: Polder Knowledge can send your campaign on the fly or schedule your campaign to got out at a set time.
...
- Yes: If there is not a list set up in your Polder Knowledge account, then you’ll need to create a list before sending your first campaign.
- No: If there is not a list set up in your Polder Knowledge account, you’ll need to create a list before sending your first campaign.
...
- Yes: Many believe that buying a list of email addresses and sending to the list through Polder Knowledge is okay. Such action can actually cause high of rates abuse, bounces, and unsubscribes. Purchasing a list and sending to it may cause your account to be suspended.
- No: Many believe that buying a list of email addresses and sending to the list through Polder Knowledge is okay. This can actually cause high rates of abuse, bounces, and unsubscribes. It can ultimately cause your account to be suspended.
...
#### Adjectives
 ...
 - Yes: At the top of the page, there is Mark with a smile on his face.
 - No: At the top of the page, there is a smiling Mark.
...
#### Currency
All clients are currently doing  eurzone where the euro is the currency. For international products is important to specify this is the currency use.
