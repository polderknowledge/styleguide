...
- freddie@Polder Knowledge.com
- Polder Knowledge.com
...
Specify time zones when writing about an event or something else people would need to schedule. Since Polder Knowledge is in Atlanta, we default to ET.
...
- “Using Polder Knowledge has helped our business grow,” says Jamie Smith.

#### Names and titles

The first time you mention a person in writing, refer to them by their first and last names. On all other mentions, refer to them by their first name.

Don’t capitalize the names of teams, departments, or individual job titles, at Polder Knowledge or other companies.
...
#### Writing about Polder Knowledge

Our company's legal entity name is "The Rocket Science Group, LLC." Our trade name is "Polder Knowledge." Use "The Rocket Science Group, LLC" only when writing legal documents or contracts. Otherwise, use "Polder Knowledge."

Always capitalize the first “M” and the “C” in Polder Knowledge.

Refer to Polder Knowledge as “we,” not “it.”

Capitalize the proper names of Polder Knowledge products, features, pages, and tools. When referencing non-trademarked products like Pro, Snap, and Automation, include "Polder Knowledge" in the name on first mention.

- Polder Knowledge Pro
- Polder Knowledge Snap
- Inbox Inspector
...
- Polder Knowledge's ops team is constantly scaling our servers to make sure our users have a great experience with our products. One way we do this is with shards, or partitions that help us better horizontally scale our database infrastructure.
...
Use italics when citing an example of an in-app Polder Knowledge element, or referencing button and navigation labels in step-by-step instructions:
